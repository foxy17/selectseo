		...
		<div class="nav-container">
			...
			<nav class="nav-center">
				...
				<a
					href="/what-this-does/"
					class="nav-link"
					class:active={page.url.pathname.startsWith('/what-this-does')}>What this does</a
				>
				<a
					href="/how-to-use/"
					class="nav-link"
					class:active={page.url.pathname.startsWith('/how-to-use')}>How to use</a
				>
			...
			<div class="nav-right">
				{#if appState.hasResults}
					<button
						class="btn-new-crawl font-mono"
						onclick={triggerNewCrawl}
						title="Start a new website scan"
					>
						<svg
							class="new-crawl-icon"
	...
	<footer class="footer">
		<div class="footer-container">
			<div class="footer-left">
				...
				<p class="footer-desc">
					High-performance, developer-first SEO scanner and analysis panel running entirely in your
					browser.
				</p>
			</div>
			<div class="footer-grid">
				...
				<div class="footer-col">
					...
					<ul>
						...
						<li>
							<a href="https://testmyiframe.in" target="_blank" rel="noopener">I-Frame testing</a>
						</li>
					</ul>
				</div>
			</div>
