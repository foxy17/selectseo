	...
	{:else if data}
		...
		<div class="gauge-score-row mt-2">
			...
			<div class="score-meta">
				<span
					class="score-grade font-mono"
					class:text-success={lighthouseBand(score) === 'success'}
					class:text-warning={lighthouseBand(score) === 'warning'}
					class:text-error={lighthouseBand(score) === 'error'}
				>
