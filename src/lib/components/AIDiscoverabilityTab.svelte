...
<div class="ai-discoverability-tab">
	<div class="score-card card-dark">
		...
		<p class="section-desc mt-1">
			This score evaluates how well your content is structured for AI models like ChatGPT, Gemini,
			and Perplexity to read, extract facts, and cite as a source.
		</p>
	</div>
	...
	<div class="audit-grid grid grid-2 mt-4">
		...
		<div class="audit-card card-dark">
			<div class="row-between">
				...
				<span
					class="status-badge"
					class:status-ok={audit.qaFormatting.status === 'ok'}
					class:status-warn={audit.qaFormatting.status === 'warning'}
				>
		...
		<div class="audit-card card-dark">
			<div class="row-between">
				...
				<span
					class="status-badge"
					class:status-ok={audit.scannability.status === 'ok'}
					class:status-warn={audit.scannability.status === 'warning'}
				>
		...
		<div class="audit-card card-dark">
			<div class="row-between">
				...
				<span
					class="status-badge"
					class:status-ok={audit.semanticHtml.status === 'ok'}
					class:status-warn={audit.semanticHtml.status === 'warning'}
				>
		...
		<div class="audit-card card-dark">
			<div class="row-between">
				...
				<span
					class="status-badge"
					class:status-ok={audit.targetSchema.status === 'ok'}
					class:status-warn={audit.targetSchema.status === 'warning'}
				>
		...
		<div class="audit-card card-dark" style="grid-column: 1 / -1">
			<div class="row-between">
				...
				<span
					class="status-badge"
					class:status-ok={audit.robotsTxtAi.status === 'ok'}
					class:status-warn={audit.robotsTxtAi.status === 'warning'}
				>
